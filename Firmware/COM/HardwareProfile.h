...
/** USB ************************************************************/
	...
	#define mInitEncoder()		TRISEbits.TRISE2=1;TRISCbits.TRISC0=1;TRISCbits.TRISC1=1;TRISCbits.TRISC2=1;
	#define ENC_A				PORTEbits.RE2
	#define ENC_B				PORTCbits.RC0
	#define ENC_C				PORTCbits.RC1
	#define ENC_D				PORTCbits.RC2
    
    /** SWITCH *********************************************************/
    #define mInitAllSwitches()  TRISCbits.TRISC7=1;TRISBbits.TRISB6=1;
    #define pb2                 PORTCbits.RC7
    #define pb1					PORTBbits.RB6
